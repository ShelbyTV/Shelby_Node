...
(function(){
  var Connection, ResponseHandler, make_command_method, net;
  ...
  var Client = function(){
    var self = this;
    this.DEFAULT_ADDR = '127.0.0.1';
    this.DEFAULT_PORT = 11300;
    this.LOWEST_PRIORITY = 4294967295;
    this.connect = function(server, callback) {
      ...
      stream.on('close', function(event) {
        self.trigger('stream_end'); 
